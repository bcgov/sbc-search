...
NICKNAMES = [
    {'name_id': 1, 'name': 'LILLIAN'},
    {'name_id': 1, 'name': 'LILY'},
    {'name_id': 1, 'name': 'LILI'},
    {'name_id': 2, 'name': 'GEORGE'},
]
...
def populate():
    ...
    officer_type1 = OfficerType(
        officer_typ_cd='SEC', short_desc='Secretary', full_desc='Secretary',
    )
    db.session.add(officer_type1)

    officer_type2 = OfficerType(
        officer_typ_cd='DIR', short_desc='Director', full_desc='Director',
    )
    db.session.add(officer_type2)

    officer_type3 = OfficerType(
        officer_typ_cd='INC', short_desc='Incorporator', full_desc='Incorporator',
    )
    ...
    corp_op_state1 = CorpOpState(
        state_typ_cd='ACT', op_state_typ_cd='ACT', short_desc='Act', full_desc='Active',
    )
