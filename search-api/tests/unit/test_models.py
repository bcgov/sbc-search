...
def test_corporation_search(session):
    """Assert that Corporations can be found by name."""
...
def test_corp_party_search(session):
    """Assert that CorpParty entities can be found and sort order is correct."""
    args = ImmutableMultiDict(
        [('field', 'lastNme'), ('operator', 'exact'), ('value', 'PATTERSON'),
         ('mode', 'ALL'), ('page', '1'), ('sort_type', 'dsc'), ('sort_value', 'lastNme'),
